...
class FindfriendsEnv(Env):
    ...
    def __init__(self, config):
        from rlcard.games.findfriends.utils import ACTION_2_ID, ID_2_ACTION
        from rlcard.games.findfriends.utils import cards2str, cards2str_with_suit
        from rlcard.games.findfriends import Game
    ...
    def get_action_feature(self, action):
        ''' For some environments such as findfriends, we can have action features
